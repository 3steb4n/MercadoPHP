                            ...
                            <table border="0" align="center" width="590" cellpadding="0" cellspacing="0" class="container590">
                                ...
                                <tr>
                                    <td align="center" height="70" style="height:70px;">
                                        <a style="display: block; border-style: none !important; border: 0 !important;"><img width="100" border="0" style="display: block; width: 100px;" src="https://i.pinimg.com/originals/a9/83/c4/a983c4fca540fe1b27bcdfadc86cfefb.png" alt="" /></a>
                                    </td>
                                </tr>
                            </table>
                        </td>
                            ...
                            <table border="0" width="400" align="center" cellpadding="0" cellspacing="0" class="container590">
                                <tr>
                                    <td align="center" style="color: #888888; font-size: 16px; font-family: "Work Sans", Calibri, sans-serif; line-height: 24px;">
                                        ...
                                        Presiona el botón de abajo para poder realizar el cambio de tu clave.
                                        </div>
                                    </td>
                                </tr>
                            </table>
                                ...
                                <tr>
                                    <td align="center" style="color: #ffffff; font-size: 14px; font-family: "Work Sans", Calibri, sans-serif; line-height: 26px;">
                                        ...
                                        <div style="line-height: 26px;">
                                            <a href="http://localhost/Mercado%20-%20Proyecto/MercadoPHP/Proyecto/Vista/RecuperarContrase%C3%B1a.html" style="color: #ffffff; text-decoration: none;">CAMBIAR CLAVE</a>
                                        </div>
                                    </td>
                                </tr>
                        ...
                        <td>
                            <table border="0" width="300" align="left" cellpadding="0" cellspacing="0" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="container590">
                                ...
                                <tr>
                                    <!-- logo -->
                                    <td align="left">
                                        <a href="" style="display: block; border-style: none !important; border: 0 !important;"><img width="80" border="0" style="display: block; width: 80px;" src="../../Iconos_o_Imagenes/laptop.png" alt="" /></a>
                                    </td>
                                </tr>
...
if(mail($to_email,$subject,$message,$headers)){
    include 'CambiarEstadoClave.php';
    $functionInstance = new CambiarEstadoClave();
    $startFunction = $functionInstance->UpdateState($email);
}else{
