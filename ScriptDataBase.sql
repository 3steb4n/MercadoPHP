...
CREATE TABLE TIPO_ESTADOS(
    ID_TIP_ESTADO INT (2) NOT NULL,
    NOMBRE_TIP_ESTADO VARCHAR (30) NOT NULL,
...
CREATE TABLE EMPRESA_TRANSPORTADORA(
    ID_TRANSPORTADORA INT(3) NOT NULL,
...
CREATE TABLE DETALLE_PRODUCTO(
    ID_DETALLE_PRODUCTO INT(3) NOT NULL,
    FECHA_VENCIMIENTO DATE,
    TALLA_PRODCUTO VARCHAR(5),
